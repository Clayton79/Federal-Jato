...
if ($categoria !== '' && $categoria !== 'Filtrar por categoria') {
    $where[] = 'categoria=?';
    $args[] = $categoria;
}
  ...
  Histórico
    ...
    <div class="container">
        ...
        <form method="POST" action="servicos.php" class="new-service-btn" style="display:flex;gap:8px;align-items:center;margin-bottom:16px;">
            ...
            <span class="novo-servico-texto" style="margin-right:12px;">Novo Serviço</span>

<div class="input-box">
  <input type="text" name="nome" class="input-clean" placeholder="Nome do Serviço" required>
</div>

<div class="input-box">
  <input type="number" step="0.01" name="preco" class="input-clean" placeholder="Preço (R$)" required>
</div>


   <div class="input-box">
  <input type="number" name="duracao_min" class="input-clean" placeholder="Duração (min)">
</div>

            <!-- <input type="text" name="categoria" placeholder="Categoria"> -->

<div class="select-box">
  <select name="categoria" class="select-clean">
    <option value="">Selecione a Categoria</option>
    <option value="lavagem"   <?= $categoria==='lavagem'?'selected':'' ?>>Lavagem</option>
    <option value="pendente"  <?= $categoria==='pendente'?'selected':'' ?>>Pendente</option>
    <option value="cancelada" <?= $categoria==='cancelada'?'selected':'' ?>>Cancelada</option>
  </select>
  <span class="select-caret">▾</span>
</div>
            <div class="input-box input-box--wide">
  <input type="text" name="descricao" class="input-clean" placeholder="Descrição">
</div>
